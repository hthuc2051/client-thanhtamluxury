...
class VideosPricePageContainer extends Component {

    render() {
        return (
            <div className="container albums_menu">
                <h2 className="page_title text-center" style={{ marginBottom :'1em' }}>Bảng giá quay videos</h2>
...
export default VideosPricePageContainer;
