...
class AdminPage extends Component {
                    ...
                    <div className={classes.root}>
                        ...
                        >
                            ...
                            <List
                                ...
                                {['Trang chủ', 'Danh sách albums', 'Danh sách áo cưới', 'Danh sách videos'].map((text, index) => (
                                    <ListItem button key={text} onClick={()=>this.handleChangeMenu(text)} >
                                        <ListItemIcon>
                            ...
                            <Collapse in={this.state.toggleOpen} timeout="auto" unmountOnExit>
                                <List component="div" disablePadding style={{ paddingLeft: '0.5em' }}>
                                    <ListItem button className={classes.nested}>
                                        <ListItemIcon>
                                            <StarBorder />
                                        </ListItemIcon>
                                        <ListItemText inset primary="Bảng giá albums" />
                                    </ListItem>
                                    <ListItem button className={classes.nested}>
                                        <ListItemIcon>
                                            <StarBorder />
                                        </ListItemIcon>
                                        <ListItemText inset primary="Bảng giá videos" />
                                    </ListItem>
                                    <ListItem button className={classes.nested}>
                                        <ListItemIcon>
                                            <StarBorder />
                                        </ListItemIcon>
                                        <ListItemText inset primary="Bảng giá trọn gói" />
                                    </ListItem>
    ...
    selectIcon(text) {
        switch (text) {
            case 'Trang chủ':
                return <InboxIcon />;
            case 'Danh sách albums':
                return <MailIcon />;
            case 'Danh sách videos':
                return <InboxIcon />;
            case 'Danh sách áo cưới':
                return <MailIcon />;
            default:
                return <MailIcon />;
        }
